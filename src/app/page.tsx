  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--bg)", color: "var(--text)" }}>
          ...
          {connected === false && (
            <a
              ...
              style={{
                ...
                borderRadius: 8, color: "#60a5fa", fontSize: 13, fontWeight: 500,
      ...
      <main style={{ maxWidth: 900, margin: "0 auto", padding: "40px 24px" }}>
        ...
        {/* Google Ads not connected banner */}
        {connected === false && accounts.length === 0 && !loading && (
          <div style={{
            ...
            <div>
              <div style={{ fontSize: 15, fontWeight: 600, marginBottom: 6 }}>Connect Google Ads to get started</div>
              <p style={{ fontSize: 13, color: "var(--text-muted)", lineHeight: 1.5 }}>
                Authorize access to your MCC so you can import accounts and pull live performance data.
              </p>
            </div>
            <a
              href="/api/auth/google-ads"
              style={{
                ...
                background: "#1d4ed8", borderRadius: 10, color: "#fff",
        ...
        {loading ? (
          ...
          <div style={{
            ...
            <p style={{ color: "var(--text-dim)", fontSize: 14 }}>No accounts yet.</p>
            <p style={{ color: "var(--text-faint)", fontSize: 13, marginTop: 6 }}>
              Click <strong style={{ color: "var(--text-muted)" }}>Add accounts</strong> above to import from your MCC.
            </p>
          </div>
        ) : (
